...
func generateMovies(_ count: Int) -> [Movie] {
    ...
    for _ in 0..<count {
        ...
        let previewImages = ["travelersPreview", "darkPreview", "dirtyJohnPreview", "whiteLinesPreview", "arrestedDevPreview", "ozarkPreview"]
        ...
        let defEpiInfo = CurrentEpisodeInfomation(episodeName: epiname, description: epidesc, season: 1, episode: 1)
        ...
        let movie = Movie(
            ...
            creators: creators,
            cast: cast,
            previewImageName: previewImages.randomElement()!,
